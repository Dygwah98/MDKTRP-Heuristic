...
#include<vector>
#include"../controller/base_data.h"
#include"individual/test.h"
#include"individual/individual.h"
#include"individual/utils.h"

class GeneticAlgorithmData : public BaseData {
    ...
    public:
        ...
        GeneticAlgorithmData(): BaseData() {}
};

double GeneticAlgorithm(const Test& instance, const Individual& ind, const BaseData& data) {
